...
4.3.0.zip, in the wsdl-first-cxf-sa/target directory.
...
- Using Hot Deployment
  ...
  Copy the wsdl-first-cxf-sa/target/wsdl-first-cxf-sa-4.3.0.zip
...
- Using the ServiceMix Console
  ...
  osgi:install -s mvn:org.apache.servicemix.examples.cxf-wsdl-first/wsdl-first-cxf-sa/4.3.0/zip
...
[ 183] [Active     ] [       ] [     ] [   60] mvn:org.apache.servicemix.examples.cxf-wsdl-first/wsdl-first-cxf-sa/4.3.0/zip
